...
<article class="card"><h2>Seed auto-update</h2><p class="muted">One-time user opt-in enables bounded host-side automatic activate, reinforce, tighten, or retire. This aggregate, redacted telemetry cannot expose seed content or affect capabilities, quota, sleep, rewards, TD, stopping, or self-model claims.</p><pre id="standingSeedPolicy">Loading…</pre></article>
